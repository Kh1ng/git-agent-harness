...
use self::attempts::{
    ...
    clear_wip_checkpoints, decide_route, ensure_bin, failure_text_with_internal_log,
...
mod tests {
    ...
    use super::{
        apply_authoritative_work_identity, apply_diff_stats, apply_pm_plan,
        build_experiment_mr_body, build_fix_or_improve_mr_body, build_pm_plan_task,
