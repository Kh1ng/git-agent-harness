...
pub(super) fn external_approval_gaps_for_work_item(
    cfg: &GahConfig,
    profile_name: &str,
    profile: &Profile,
    work_id: Option<&str>,
...
pub(super) fn run_backend_with_reserved_route(
    ...
    let gaps = external_approval_gaps_for_work_item(cfg, profile_name, profile, work_id, env_path);
    if !gaps.is_empty() {
        return Err(anyhow::Error::new(ExternalApprovalRequiredError {
