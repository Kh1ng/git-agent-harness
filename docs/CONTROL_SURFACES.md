...
| Map view | Choose the node and dependency map format. The Work page already shows ticket lifecycle waypoints and project stage totals. | [#799](https://github.com/Kh1ng/git-agent-harness/issues/799), [#800](https://github.com/Kh1ng/git-agent-harness/issues/800) |
