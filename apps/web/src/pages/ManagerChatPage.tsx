...
export function ManagerChatPage() {
  ...
  useEffect(() => {
    ...
    if (!last || !pendingRequestId) return;
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Manager Chat" description={`Talking to the manager for profile "${profile}"`} />
      ...
      <div className="card-padded flex flex-col h-[65vh]">
        ...
        <div className="flex items-end gap-2 pt-3 mt-3 border-t border-subtle">
          <textarea
            ...
            placeholder={isConnected ? 'Message the manager…' : 'Not connected to server'}
