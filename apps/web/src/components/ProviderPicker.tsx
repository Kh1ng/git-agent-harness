  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="inline-flex max-w-[14rem] max-sm:max-w-[8rem] items-center gap-1.5 rounded-md border border-subtle bg-raised px-2 py-2 text-xs text-secondary hover:bg-white/5 disabled:opacity-50"
      >
