...
export function Navbar({ currentPage, onPageChange, activityUnreadCount }: NavbarProps) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className={`hidden lg:sticky lg:top-0 lg:w-56 lg:shrink-0 lg:flex-col lg:border-r lg:border-subtle lg:bg-card lg:p-3 ${currentPage === 'chat' ? 'lg:row-start-2 lg:flex lg:h-full lg:min-h-0' : 'lg:flex lg:h-screen'}`}>
